...
num_trials = 50000 # 1k points ~ 27 minutes with videos, 30 seconds without videos 
dir_results = "./results/data_v4" 
...
for idx_trial in range(num_trials): 
    ...
    x0 = 2*(np.random.rand() - 0.5) * 1e-3 * 1.0 
    y0 = 2*(np.random.rand() - 0.5) * 1e-3 * 1.0 
    z0 = 2*(np.random.rand() - 0.5) * 1e-3 * 1.0 - 5e-3 
    a0 = 2*(np.random.rand() - 0.5) * (np.pi/180) * 5.0 
    b0 = 2*(np.random.rand() - 0.5) * (np.pi/180) * 5.0 
    c0 = 2*(np.random.rand() - 0.5) * (np.pi/180) * 5.0 
